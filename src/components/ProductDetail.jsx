...
const ProductDetails = () => {
    ...
    const product = firstProducts.find(product => product.slug === slug)
    if (!product) {
                ...
                <h1 className="uppercase text-[2.2rem] mb-1 block lg:hidden px-2">{product.name}</h1>
                    ...
                    <div className="w-full lg:w-1/2 lg:pl-3 ">
                        <div className="m-2">
                            ...
                            <p className="flex items-center gap-2">or 4 interest-free payments of $124.75 with 
                            ...
                            {isAdded && 
                                <div className="alert alert-success mt-2 flex justify-between">Added to bag!
                                    <button onClick={() => setIsAdded(false)}>
                            ...
                            <div className="flex gap-2 mt-5">
                                ...
                                <div>
                                    <button onClick={ handleAddToCart} className="py-2 px-7 rounded-full bg-blue-900 text-white">ADD TO BAG</button>
                                </div>
                            </div>
                        </div>
