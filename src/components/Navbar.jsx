...
const Navbar = () => {
  ...
  return (
    <>
            ...
            <ul className="flex lg:gap-6 place-items-center ">
              <div className="hidden lg:flex items-center gap-6">
                ...
                >
                  <a
                    onClick={() => handleClick()}
                    className="py-[.5rem] px-[.5rem] flex items-center"
                    href="#"
                  >
                    workflows <MdArrowDropDown className="text-xl" />
                  </a>
                  {isDropdown && (
                    <div className="bg-white absolute" id="workflow">
                      <ul className="uppercase py-2 cursor-pointer">
                        <li>
              ...
              <button className="block lg:hidden py-[.25rem] px-[.75rem]" onClick={() => setIsMobileMenu((prev) => !prev)}>
                <svg
                  width="30"
                  height="30"
                  aria-hidden="true"
              ...
              <div className="flex items-center">
                <button className="nav-item px-[.5rem]" onClick={() => setIsCart((prev) => !prev)}>
                ...
                <li className="nav-item font-semibold lg:font-normal text-[.8rem]">
                  <a
                    className="py-[.5rem] flex items-center"
                    href=""
                  >
                    <span className='hidden sm:block'> usd </span> <span className='sm:hidden text-lg block'>$</span> <MdArrowDropDown className="text-xl" />
                  </a>
                </li>
              </div>
            </ul>
      ...
      {isCart && <div className="bg-[rgba(0,0,0,0.6)] w-full h-full absolute top-0 inset-0 z-50 "></div>}
      <div className={`max-w-[350px] h-full z-50 fixed right-0 top-0 w-full transform transition-transform duration-700 delay-100 ease-in-out ${isCart ? 'translate-x-0' : 'translate-x-full'}`}>        
          <div className={`w-full h-full bg-[#1a2456] text-white absolute right-0 top-0 flex flex-col `}>
            <header className="uppercase py-4 px-6">
              <button className="flex items-center gap-2 uppercase py-2" onClick={() => setIsCart(false)}>
                <MdKeyboardArrowLeft className="text-2xl" /> continue shopping{" "}
              </button>
            </header>
            ...
            <footer className="uppercase py-3 px-6 ">
              <div className="m-[.25rem]">
                ...
                <div className="">
                  <button 
                    className={`${cartItems.length === 0 ? 'opacity-50 cursor-not-allowed' : 'opacity-100'} w-full py-3 mb-3 bg-[#EFC2B3] text-[#1a2456] rounded-full uppercase font-[600]`}>
                    checkout
                  </button>
      ...
      {isMobileMenu && <div className="bg-[rgba(0,0,0,0.6)] w-full h-full absolute top-0 inset-0 z-50 "></div>}
      <div id="mobileNav" className={`w-[350px] h-full color z-50 fixed left-0 top-0 w-full transform transition-transform duration-700 delay-100 ease-in-out ${isMobileMenu ? 'translate-x-0' : '-translate-x-full'}`}>        
          <div className={` h-full bg-[#1a2456] absolute left-0 top-0 flex flex-col `}>
            <header className="uppercase pl-6">
              <div className="flex justify-between w-full items-center gap-2 uppercase py-2">     
                <a href="">         
                  <svg height="38" viewBox="0 0 520 114" fill="currentColor">
                    <title>Monogram</title>
                    <path d="M150,36V0H0V114H150ZM144,6V36H78V6ZM6,6H72V72H6ZM72,108H6V78H72Zm72,0H78V78h0V42h66Z"></path>
